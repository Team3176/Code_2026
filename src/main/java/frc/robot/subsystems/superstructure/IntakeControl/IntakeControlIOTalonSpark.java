...
public class IntakeControlIOTalonSpark implements IntakeControlIO {
  ...
  public IntakeControlIOTalonSpark() {
   ...
   // IntakePositionEncoder = new CANcoder(Hardwaremap.IntakePositionCancoder_CID, Hardwaremap.Intake_CBN);
    ...
    //Gains for Deploy 
    IntakePositionConfigs.Slot0.kP = 2.2; // An error of 1 rotation results in 2.4 V output
    ...
    //Gains for Retract
    IntakePositionConfigs.Slot1.kP = 2.1; // An error of 1 rotation results in 2.4 V output
