            ...
            //cameraContainer aCameraContainer = BaRightContainer;
                ...
                for (var result : aCameraContainer.thisCamera.getAllUnreadResults()) {
                    ...
                    if (!visionEst.isEmpty()) {
                        ...
                        thisCommandSwerveDrivetrain.addVisionMeasurement(visionEst.get().estimatedPose.toPose2d(),visionEst.get().timestampSeconds);
                        ...
                        VisionRest[4] = thisCommandSwerveDrivetrain.samplePoseAt(Timer.getFPGATimestamp()).get().getRotation().getDegrees();
