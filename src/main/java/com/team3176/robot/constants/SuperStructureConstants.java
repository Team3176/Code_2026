...
public class SuperStructureConstants {
  ...
  public static final double GenericTalon_MAX_OUTPUT_VOLTS = 2.5; //Sets Max forward Speed
  public static final double GenericTalon_MAXNeg_OUTPUT_VOLTS = -2.5; //Sets Max Reverse Speed
   public static final double GenericTalon_kP = 1;
