...
public class SuperStructureConstants {
  ...
  public static final double GenericTalon_OUTPUT_POWER = 1;
  public static final int    GenericTalon_CURRENT_LIMIT_A = 15;
  public static final double GenericTalon_kP = 0.006;
  public static final double GenericTalon_kI = 0; // .0025
  public static final double GenericTalon_kD = 0; // .001
  public static final double GenericTalon_kg = 0.2;
  public static final double GenericTalon_TOLERANCE = 3;
  public static final double GenericTalon_ZERO_POS = 0.39;
  public static final double GenericTalon_TOP_POS = 75 + GenericTalon_ZERO_POS;
  ...
  public static final double GenericTalon_L0_POS = 0.16;
  public static final double GenericTalon_L1_POS = 0.34;
  ...
  public static final double GenericTalon_L3_SHOOTINGVOLTS = 10;
  public static final double GenericTalon_L4_SHOOTINGVOLTS = 10;
