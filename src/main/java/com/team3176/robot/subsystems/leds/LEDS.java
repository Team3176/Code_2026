...
public class LEDS extends SubsystemBase {
  ...
  public boolean requestShoot = false;
  ...
  //TODO change this to 2026 game modes 
  public Command Shooting() {
    return this.runEnd(() -> requestShoot = true, () -> requestShoot = false);
  }
  ...
  public synchronized void periodic() {
    ...
    if (estopped) {
      ...
      //TODO add interfaces to 2026 mechs
